// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LoggerConfigurationMicrosoftTeamsExtensions.cs" company="Haemmer Electronics">
...
namespace Serilog
{
    ...
    public static class LoggerConfigurationMicrosoftTeamsExtensions
    {
        ...
        public static LoggerConfiguration MicrosoftTeams(
            ...
            string proxy = null)
        {
            var microsoftTeamsSinkOptions = new MicrosoftTeamsSinkOptions(webHookUri, title, batchSizeLimit, period, formatProvider, proxy: proxy);
